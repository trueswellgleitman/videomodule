...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.79.01), Fri Oct 23 01:26:10 2015
...
expName = u'text experiment'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/trueswelllab/Downloads/videomodule-master/text experiment.psyexp',
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        elif mouse.status == STARTED and t >= (0.0 + 100000000):
